...
{
public:
    CEvent(EventType event, std::string image, std::string message, std::shared_ptr<CombatReport> rep);
...
private:
    ...
    std::string        m_ImageType;              // Image Type of message
...
public:
    ...
    void            AddMessage(std::string message, std::string, EventType event_type);
